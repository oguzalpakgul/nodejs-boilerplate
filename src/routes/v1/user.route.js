...
router.route('/').post(auth('user:add'), validate(userValidation.createUser), userController.createUser);
...
router
  ...
  .put(auth('user:edit'), validate(userValidation.updateUser), userController.updateUser)
